...
const Count = () => {
    ...
    return (
        <div className='mt-10 container mx-auto'>
             ...
             <div className='grid grid-cols-1 gap-5  md:grid-cols-2 lg:grid-cols-3 ml-20 md:ml-20 lg:ml-40'>
             <div className='border-2 shadow-xl border-red-700 w-3/4 text-center py-5'>
